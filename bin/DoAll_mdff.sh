#!/bin/bash
MPIRUN=~/devel/openmpi-1.4.5-intel/bin/mpirun
exe=/home/filipe/mdff/bin/mdff.x
...
init_random()
{
    ...
    echo "-----------------------------------"
    random_struct.py -n 90 -i "60 30" -t "O Si" -a "11.0757 0.0 0.0" -b "0.0 11.0757 0.0" -c "0.0 0.0 11.0757"
...
docp()
{
    ODIR=$1
    mkdir $ODIR
    for file in control.F CONTFF POSFF OSZIFF log TRAJFF ; do
	[ -f $file ] && mv $file $ODIR/
    done
