...
! barostat
  ...
  io_printnode write(stdout,'(i,a,7e16.8)') trotter_order,'ve out
',s,sb,ve/W,Ge,pvirial_tot,press
#endif
  endif
...
SUBROUTINE prop_pos_vel_verlet_npt ( kin , xe , ve , xe0 , L , W )
  ...
  !io_node print*,'xe',xe,xe0,EXP(xe-xe0)
  xe0 = xe 
