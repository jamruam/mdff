...
SUBROUTINE Nymand_and_Linse_test
  ...
  USE field,    ONLY : ef_t , efg_t , qch , dip , lpolar , field_init , rm_coul , km_coul , initialize_coulomb , finalize_coulomb,  &
                       engforce_charge_DS , engforce_charge_ES , engforce_dipole_DS , engforce_dipole_ES , engforce_charge_and_dipole_DS, alphaES! , &
...
SUBROUTINE NL_field_print_info ( kunit ) 
  ...
  USE config,   ONLY :  box
  USE field,    ONLY :  ncelldirect , ncellewald , cutlongrange , alphaES 
...
SUBROUTINE moment_from_pola ( iastart , iaend , mu_ind ) 
  ...
  USE config,  ONLY : natm , atype , fx , fy , fz , ntype , dipia
  ...
  double precision :: Efield( natm , 3 ) , Efield_stat ( natm , 3 ) , Efield_ind ( natm , 3 ) , ef_tmp( natm , 3 )
